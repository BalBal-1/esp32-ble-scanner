...
{ 0x003A, "Matsushita Electric Industrial Co." },
...
{ 0x008C, "Gimbal Inc. (formerly Qualcomm Labs" },
...
{ 0x00D3, "Taixingbang Technology (HK) Co" },
{ 0x00D4, "Kawantech" },
...
{ 0x010E, "Audi AG" },
{ 0x010F, "HiSilicon Technologies Col" },
...
{ 0x0140, "Alpine Electronics (China) Co." },
...
{ 0x01F8, "Anyka (Guangzhou) Microelectronics Technology Co" },
...
{ 0x0351, "Pieps GmbH" },
{ 0x0352, "iRiding(Xiamen)Technology Co." },
...
{ 0x03E0, "Actions (Zhuhai) Technology Co." },
